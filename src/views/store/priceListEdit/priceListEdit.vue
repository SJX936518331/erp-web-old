  ...
  <div class="container">
    ...
    <div style="width:380px;text-align:left;margin-left:30px;">
      <div style="width:70px;text-align:left;display:inline-block;">
        <label>
          <span style="color:red;">*</span>调价仓库</label>
      </div>
      <div style="width:300px;text-align:right;display:inline-block;height:40px;">
        <Form ref="warehouseForm" :model="warehouseForm" :rules="validate">
          <FormItem prop="priceWarehouse">
            <Select style="text-align:left" v-model="warehouseForm.priceWarehouse" placeholder="请选择调价仓库">
    ...
    <Modal v-model="modal" title="添加商品" @on-ok="ok" @on-cancel="cancel">
      <Form ref="editForm" :model="editForm" :label-width="100" label-position="right" :rules="validateForm">
        ...
        <FormItem label="调前单价" prop="beforePrice">
          <Input v-model="editForm.beforePrice" placeholder="请输入单价"></Input>
        </FormItem>
        <FormItem label="调后单价" prop="endPrice">
          <Input v-model="editForm.endPrice" placeholder="请输入单价"></Input>
        </FormItem>
        <FormItem label="盈亏金额" prop="money">
...
export default {
  ...
  methods: {
    ...
    save() {
      if (
        this.warehouseForm.priceWarehouse == "" ||
    ...
    ok() {
      if (
        ...
        this.editForm.beforePrice == null ||
        this.editForm.endPrice == null ||
        ...
        this.data1.push({
          ...
          beforePrice: this.editForm.beforePrice,
          endPrice:this.editForm.endPrice,
