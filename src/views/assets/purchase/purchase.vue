  ...
  <div class="container">
    ...
    <div style="width:380px;text-align:left;margin-left:30px;">
      ...
      <div style="width:300px;text-align:right;display:inline-block;">
        <Input style="margin:10px;" v-model="id" placeholder="GJ-201809277737"></Input>
      </div>
      <div style="width:50px;text-align:left;display:inline-block;">
        <label>
      ...
      <div style="width:60px;text-align:left;display:inline-block;">
        <label>
          <span style="color:red;">*</span>供货单位</label>
      </div>
      <div style="width:300px;text-align:right;display:inline-block;">
        <Input style="margin:10px;margin-left:0px;" v-model="danwei" placeholder="请输入供货单位"></Input>
      </div>
      <div style="width:50px;text-align:left;display:inline-block;">
        <label>&nbsp;备注</label>
      </div>
      ...
      <div style="width:60px;;text-align:left;display:inline-block;">
        <label>
          <span style="color:red;">*</span>付款账户</label>
      </div>
      <div style="width:300px;text-align:right;display:inline-block;">
        <Input style="margin:10px;margin-left:0px;" v-model="account" placeholder="请输入付款账号"></Input>
      </div>
    </div>
