  ...
  <div class="container">
    ...
    <div style="width:380px;text-align:left;margin-left:30px;">
      <div style="width:60px;text-align:left;display:inline-block;">
        <label>
          <span style="color:red;">*</span>收购单位</label>
      </div>
      <div style="width:300px;text-align:right;display:inline-block;">
        <Input style="margin:10px;" v-model="danwei" placeholder="请输入收购单位"></Input>
      </div>
      <div style="width:60px;text-align:left;display:inline-block;">
        <label>
      ...
      <div style="width:300px;text-align:right;display:inline-block;">
        <Input style="margin:10px;" v-model="account" placeholder="请输入收款账号"></Input>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    save: function() {
      if (this.danwei == "" || this.beizhu == "" || this.account == "") {
        this.$Modal.info({
          title: "提示",
