<template>
  <div class="container">
    ...
    <div style="width:100%;text-align:left;">
      ...
      <div style="text-align:left;margin:10px 0px 10px 25px;">
        ...
        <Form style="display:inline-block;width:200px;" ref="editForm" :model="editForm" :rules="validate">
          <FormItem prop="warehouse">
            <Select style="text-align:left" v-model="editForm.warehouse" placeholder="请选择仓库">
              <Option value="">请选择</Option>
      ...
      <div style="text-align:left;margin:10px 0px 10px 2px;">
        <label>入库类型:</label>
        <Form style="display:inline-block;width:200px;" ref="editForm" :model="editForm" :rules="validate">
          <FormItem prop="type">
            <Select style="text-align:left" v-model="editForm.type" placeholder="请选择入库类型">
              <Option value="">请选择</Option>
              <Option value="生产入库">生产入库</Option>
              <Option value="采购入库">采购入库</Option>
              <Option value="赠送入库">赠送入库</Option>
              <Option value="借用入库">借用入库</Option>
      ...
      <div style="text-align:left;margin:10px 0px 10px 2px;">
        ...
        <Form style="display:inline-block;width:200px;" ref="editForm" :model="editForm" :rules="validate">
          <FormItem prop="account">
            <Select style="text-align:left" v-model="editForm.account" placeholder="请选择付款账户">
              <Option value="">请选择</Option>
      ...
      <div style="text-align:left;margin:10px 0px 10px -8px;">
        <label>已付款金额:</label>
        <Form style="display:inline-block;width:200px;" ref="editForm" :model="editForm" :rules="validate">
          <FormItem prop="pay_money">
            <Input v-model="editForm.pay_money" placeholder="请输入已付款金额"></Input>
          </FormItem>
        </Form>
      </div>
    </div>
