  ...
  <div class="container">
    ...
    <div style="width:380px;text-align:left;margin-left:30px;">
      <div style="width:70px;text-align:left;display:inline-block;">
        <label>
          <span style="color:red;">*</span>计划对象</label>
      </div>
      <div style="width:300px;text-align:right;display:inline-block;height:60px;">
        <Form ref="companyForm" :model="companyForm" :rules="validate">
          <FormItem prop="object">
            <Select style="text-align:left" v-model="companyForm.object" placeholder="请选择计划对象">
      ...
      <div style="width:70px;text-align:left;display:inline-block;">
        <label>
          <span style="color:red;">*</span>计划区间</label>
      </div>
      <div style="width:300px;text-align:right;display:inline-block;height:60px;">
        <Form ref="companyForm" :model="companyForm" :rules="validate">
          <FormItem prop="section">
            <Select style="text-align:left" v-model="companyForm.section" placeholder="请选择计划区间">
      ...
      <div style="width:70px;text-align:left;display:inline-block;">
        <label>
          <span style="color:red;">*</span>结束日期</label>
      </div>
      <div style="width:300px;text-align:right;display:inline-block;height:60px;">
        <Form ref="companyForm" :model="companyForm" :rules="validate">
          <FormItem prop="end">
            <Select style="text-align:left" v-model="companyForm.end" placeholder="请选择结束日期">
              <Option value="2018-3-31">2018-3-31</Option>
              <Option value="2018-4-30">2018-4-30</Option>
              <Option value="2018-5-31">2018-5-31</Option>
              <Option value="2018-6-30">2018-6-30</Option>
            </Select>
          </FormItem>
        </Form>
      </div>
      ...
      <div style="width:300px;text-align:left;display:inline-block;margin-bottom:10px;">
        <Checkbox v-model="companyForm.ending"></Checkbox>
      </div>
    </div>
    ...
    <Modal v-model="modal" title="添加产品" @on-ok="ok" @on-cancel="cancel">
      <Form ref="editForm" :model="editForm" :label-width="100" label-position="right" :rules="validateForm">
        ...
        <FormItem label="业务数量" prop="number">
          <Input v-model="editForm.number" placeholder="请输入业务数量"></Input>
        </FormItem>
        <FormItem label="业务单价" prop="price">
          <Input v-model="editForm.price" placeholder="请输入业务单价"></Input>
        </FormItem>
...
export default {
  ...
  methods: {
    ...
    save() {
      if (
        this.companyForm.object == "" ||
        this.companyForm.section == "" ||
        this.companyForm.end == "" ||
